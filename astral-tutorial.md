...
```
java -jar astral.4.10.14.jar -i test_data/song_mammals.424.gene.tre
```

The results will be outputted to the standard output. To save the results in an output file use the `-o` option:

```
java -jar astral.4.10.14.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre
```
...
```
java -jar astral.4.10.14.jar -i test_data/song_mammals.424.gene.tre -o test_data/song_mammals.tre 2> song_mammals.log
```
...
```
java -jar astral.4.10.14.jar -i test_data/100-simulated-boot
```
...
```
java -jar astral.4.10.14.jar -i test_data/1KP-genetrees.tre -o test_data/1kp.tre
```
...
```
java -jar astral.4.10.14.jar -q test_data/simulated_14taxon.default.tre -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_scored.tre
```
...
```
java -jar astral.4.10.14.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 2 -o test_data/1kp-scored-t2.tre
```
```
java -jar astral.4.10.14.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 4 -o test_data/1kp-scored-t4.tre
```
```
java -jar astral.4.10.14.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -t 8 -o test_data/1kp-scored-t8.tre
```
...
```
java -jar astral.4.10.14.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 2 -o test_data/1kp-scored-c2.tre
```

```
java -jar astral.4.10.14.jar -q test_data/1kp.tre -i test_data/1KP-genetrees.tre -c 0.001 -o test_data/1kp-scored-cs.tre
``` 
...
```
java -jar ../astral.4.10.14.jar -i song_mammals.424.gene.tre -b bs-files
```
...
```
java -jar ../astral.4.10.14.jar -i song_mammals.424.gene.tre -b bs-files -r 150
```
...
```
java -jar ../astral.4.10.14.jar -i song_mammals.424.gene.tre -b bs-files -g -r 100
```
...
```
java -jar ../astral.4.10.14.jar -i song_mammals.424.gene.tre --gene-only
```
...
```
java -jar astral.4.10.14.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.exact.tre -x
```
...
```
java -jar astral.4.10.14.jar -i test_data/song_primates.424.gene.tre -o test_data/song_primates.424.default.tre
```
...
```
java -jar astral.4.10.14.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.default.tre
```

and then

```
java -jar astral.4.10.14.jar -i test_data/simulated_14taxon.gene.tre -o test_data/simulated_14taxon.exact.tre -x
```
...
```
java -jar astral.4.10.14.jar -i test_data/simulated_primates_5X.10.gene.tre -o test_data/simulated_primates_5X.10.species.tre -e test_data/simulated_primates_5X.10.bootstrap.gene.tre
```
...
```
java -Xmx3000M -jar astral.4.10.14.jar -i in.tree
```
