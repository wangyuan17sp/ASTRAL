...
//		this.similarityMatrix.pupulateByBranchDistanceBS(this.geneTrees);
//		this.similarityMatrix.pupulateByBranchDistanceBL(this.geneTrees);
...
//		this.speciesSimilarityMatrix = this.similarityMatrix.matricesByBranchDistance(this.geneTrees, spm, false);
	}
