        ...
        for (Tree cons : allGreedies) {
            ...
            for (TNode greedyNode : cons.postTraverse()) {
                ...
                this.addSubSampledBitSetToX(
                        this.speciesMatrix.resolvePolytomy(
                ...
                for (int j = 0; j < this.GREEDY_ADDITION_DEFAULT_RUNS + k; j++) {
                    ...
                    if (this.sampleAndResolve(childbs, contractedTrees, quadratic, tid,true, false) && k < GREEDY_ADDITION_MAX) {
...
//    	}
    ...
    private boolean sampleAndResolve(BitSet[] polytomyBSList, Collection<Tree> inputTrees,
            boolean addQuadratic, TaxonIdentifier tid, 
        ...
        if(addByDistance)
            resolveByDistance(polytomyBSList, randomSample, addQuadratic, tid);
